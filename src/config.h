...
/* Define to 1 if you have the `kfile' library (-lkfile). */
/* #undef HAVE_LIBKFILE */
...
/* Define to 1 if you have the `swe' library (-lswe). */
/* #undef HAVE_LIBSWE */
...
/* Name of package */
#define PACKAGE "astrolog542j"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "scharn@bluewin.ch"
